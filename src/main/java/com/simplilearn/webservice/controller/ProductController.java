...
public class ProductController {
	...
	private List<Product> getDefaultProduct(){
		products.add(new Product(1001, "Iphone 11 Pro", "It is a smart phone", 7000));
		products.add(new Product(1002, "Lenovo Laptop XYZ series", "It is a Laptop", 20000));
		products.add(new Product(1003, "Ferari", "It is a racing car", 290000));
		products.add(new Product(1004, "Dimond Ring", "It is a ring", 23000));
